...
class WithdrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdraw" do
    assert_difference('Withdraw.count') do
      post withdraws_url, params: { withdraw: { date: @withdraw.date, debt_id: @withdraw.debt_id, value: @withdraw.value } }
    end
  ...
  test "should update withdraw" do
    patch withdraw_url(@withdraw), params: { withdraw: { date: @withdraw.date, debt_id: @withdraw.debt_id, value: @withdraw.value } }
